...
from javax.swing import (BorderFactory, BoxLayout, JButton, JCheckBox, JComboBox, JLabel,
                         JPanel, JScrollPane, JSplitPane, JTabbedPane, JTextField)
from javax.swing.table import AbstractTableModel

# TODO: Review file once other functionality has been finalized
# pylint: skip-file

class TimerPanel(object):
    def __init__(self,
